...
const Navbar = () => {
  return (
    <header className="w-full px-32 py-8 font-medium flex items-center justify-between bg-light fixed z-[100]">
      <nav className="flex items-center">
        <NavLink href="/" title="Home" className="mr-4" />
        <NavLink href="#about" title="About" className="mx-4" />
        <NavLink href="#skills" title="Skills" className="mx-4" />
        <NavLink href="#education" title="Education" className="mx-4" />
        <NavLink href="#experience" title="Experience" className="mx-4" />
